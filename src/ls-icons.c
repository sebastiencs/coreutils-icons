...
static t_file_matching file_matches[] = {
  ...
  { OCT_BOOK, MATCH( F("CHANGELOG", "changelog") ), BLUE},
  ...
  { OCT_BOOK, MATCH( F("INSTALL", "install") ), DARK_BLUE},
  { OCT_BOOK, MATCH( F("HISTORY", "history") ), DARK_BLUE},
  ...
  { OCT_BOOK, MATCH( F("README", "readme", "README.md", "readme.md") ), YELLOW},
  ...
  { FILE_EMACS, MATCH( F("emacs.d") ), DARK_PURPLE},
